...
- **note記事**: 長文。目標文字数は価格帯・種類で異なる（2026-08-04更新、
  `design/AFFILIATE_ARTICLE_STANDARDS.md` §1参照）：無料note記事2,000〜3,500字／
  アフィリエイトnote記事3,000〜5,000字／¥980有料note4,000〜7,000字／
  ¥1,980有料note5,000〜8,000字／¥3,980商品記事6,000〜10,000字＋実用品。
  有料記事は導入（無料部分）で読者の状況に共感→具体的な手順・チェックリスト
  （有料部分）という構成を基本とする。
...
### 2.5 note記事の目標文字数の決定（TASK-031で追加、2026-08-04ゆうさん指示で確定）

執筆前に `design/AFFILIATE_ARTICLE_STANDARDS.md` §1bに従い、価格帯・掲載形式で
目標文字数レンジを決める（noteはWordPressの「記事タイプ別」ではなく、この
「note記事別（価格帯別）」を使う）。

- 無料note記事: 2,000〜3,500字
- アフィリエイトnote記事（無料公開・アフィリリンク含む）: 3,000〜5,000字
- ¥980有料note記事: 4,000〜7,000字
- ¥1,980有料note記事: 5,000〜8,000字
- ¥3,980商品記事（テンプレート等の実用品を含む）: 6,000〜10,000字＋実用品

検索意図の分類（同ドキュメント§2、9種類）はnoteにも適用し、構成とCTAの強さを決める。
文字数は同ドキュメント§7のQAスコアリング（100点満点・85点以上で公開候補）と合わせて
`qa_gate` 判定に含める。
