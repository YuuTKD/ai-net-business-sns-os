...
- 公開ボタンは、`CLAUDE.md`「本番投稿・公開の承認制ルール」に従い、**その投稿について
  ゆうさんの明示的な承認を得た場合に限り**Claude Codeが押してよい（2026-08-05改定、
  従来の「AIは一切押さない」方針から変更）。承認なしでの公開操作は引き続き絶対禁止。
...
8. 公開             : ゆうさんから当該投稿への明示的な承認を得た場合に限り、
                        Claude Codeが「公開」ボタンを押してよい（`CLAUDE.md`
...
- ゆうさんの投稿ごとの承認を経ないAIによる「公開」ボタン操作（承認があれば実行可、
  `CLAUDE.md`「本番投稿・公開の承認制ルール」・本SOP §3参照、2026-08-05改定）
